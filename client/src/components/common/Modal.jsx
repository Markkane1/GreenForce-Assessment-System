  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-foreground/40 p-4 backdrop-blur-sm">
      <div className="flex min-h-full items-center justify-center py-4">
        <div
          className={`relative flex max-h-[calc(100vh-2rem)] w-full max-w-2xl flex-col overflow-hidden rounded-2xl border bg-card p-8 shadow-editorialLg animate-pop-in ${panelClassName}`}
        >
          {showCloseButton ? (
            <button
              type="button"
